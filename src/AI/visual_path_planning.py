...
# In summary using the data collected from kinect this makes the decision for: 
# 1. giving the commands to the the motors 
# 2. used for conversation with the person. 
...
# Note these values are set for the current location of the kinect on the slider. 
# If the location of the kinect changes so will these valhe 
